\documentclass[anonymous]{homework}

\renewcommand{\hmwkTitle}{Lorem Ipsum}
\renewcommand{\hmwkClass}{Placeholder class}
\renewcommand{\hmwkClassInstructor}{Prof. Placeholder}
\renewcommand{\hmwkAuthorName}{Default student}
